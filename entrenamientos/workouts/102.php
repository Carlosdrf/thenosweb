        ...
        <div class="encabezado">
            <div class="contenedor-portada">
                <section class="section-portada">
                    <div class="col">
                        <?php
                        foreach($play->getRutinaObjetivo(2) as $res){
                            ...
                            foreach($play->grupoRutina(2) as $res){
        ...
        <div class="cuerpo">
            <section class="suggcontainer">
                <div class="container-exercise">
                    ...
                    <div class="card-lista shadow">
                        <div class="list-body">
                            <h4 class="card-title">Realizar 3 rondas - El tiempo de descanso se hace entre series y ejercicios de entre 45 
                            seg hasta 4 minutos en base a lo que mejor se ajuste a tu comodidad</h4>
                        </div>
                        <div class="list-group list-group-flush">
                            <?php
                                foreach($play->mostrarEjercicioRutina(2) as $res){
